      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item :label="$t('parentDept')" prop="parentId">
              <treeselect v-model="form.parentId" :options="deptOptions" :normalizer="normalizer" :placeholder="$t('pleaseEnter') + $t('parentDept')" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('deptName')" prop="deptName">
              <el-input v-model="form.deptName" :placeholder="$t('deptNamePlaceholder')"  />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('leader')" prop="leader">
              <el-input v-model="form.leader" :placeholder="$t('pleaseEnter') + $t('leader')" maxlength="20" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :label="$t('contactNumber')" prop="phone">
              <el-input v-model="form.phone" :placeholder="$t('pleaseEnter') + $t('contactNumber')" maxlength="11" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$t('deptStatus')">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        parentId: [
          { required: true, message: this.$t('parentIdRules'), trigger: "blur" }
        ],
        deptName: [
          { required: true, message: this.$t('deptNameRules'), trigger: "blur" }
        ],
        orderNum: [
          { required: true, message: this.$t('showOrderNumRules'), trigger: "blur" }
        ],
        email: [
          {
            type: "email",
            message: this.$t('emailNumRules'),
            trigger: ["blur", "change"]
          }
        ],
        phone: [
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm(this.$t('tips26') + '"' + row.deptName + this.$t('tips12') + '"？').then(function() {
