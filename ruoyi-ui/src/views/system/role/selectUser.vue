<template>
  <!-- 授权用户 -->
  <el-dialog :title="$t('selectUser')" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table stripe @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange" height="260px">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button @click="visible = false">{{$t('cancels')}}</el-button>
    </div>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    handleSelectUser() {
      ...
      if (userIds == "") {
        this.$modal.msgError(this.$t('tips16'));
        return;
      }
